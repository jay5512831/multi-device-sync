...
│   └── bug-report-workflow.md  # 反馈收集 6 步流程
└── scripts/
...
| 版本 | 更新内容 |
|------|---------|
| v1.1.0 | 渐进式披露重构：SKILL.md 387→121 行，问卷/锁文件/冲突检测/跨平台命令/反馈流程全部移到 ref，新增速查卡+资源索引表+9 种异常处理，新增 `bug-report-workflow.md` |
| v1.0.0 | 初始版本：切入/切出同步、三种架构（中转/直接/Git）、冲突检测、问题反馈 |
